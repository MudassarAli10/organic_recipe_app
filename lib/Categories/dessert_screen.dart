...
import 'package:recipe_app/List%20of%20Recipes%20Items/dessert_list.dart';
import '../constant.dart';
import '../detail_screen.dart';
//import '../favouriteScreen.dart';

class DessertScreen extends StatelessWidget {
  final List<Recipe> dessertList;
  const DessertScreen(this.dessertList, {super.key});
  @override
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: ((context) => DetailScreen(
                                              ...
                                              dessertList[index].category,
                                              dessertList[index].image,
                                              dessertList[index].time,
                                              dessertList[index].calories,
                                              dessertList[index].serving,
                                              dessertList[index]
                                                  .ingredients
                                                  .toString(),
                                              dessertList[index].instruction,
                                            ))));
                              },
                              child: Container(

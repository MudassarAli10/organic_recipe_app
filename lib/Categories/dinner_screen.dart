...
class DinnerScreen extends StatelessWidget {
  final List<Recipe> dinnerList;
  const DinnerScreen(this.dinnerList, {super.key});
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: ((context) => DetailScreen(
                                              ...
                                              dinnerList[index].category,
                                              dinnerList[index].image,
                                              dinnerList[index].time,
                                              dinnerList[index].calories,
                                              dinnerList[index].serving,
                                              dinnerList[index]
                                                  .ingredients
                                                  .toString(),
                                              dinnerList[index].instruction,
                                            ))));
                              },
                              child: Container(

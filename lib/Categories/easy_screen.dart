...
import 'package:recipe_app/List%20of%20Recipes%20Items/easy_list.dart';
import '../constant.dart';
import '../detail_screen.dart';
//import '../favouriteScreen.dart';

class EasyScreen extends StatelessWidget {
  final List<Recipe> easyList;
  const EasyScreen(this.easyList, {super.key});
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: ((context) => DetailScreen(
                                              easyList[index].name,
                                              easyList[index].category,
                                              easyList[index].image,
                                              easyList[index].time,
                                              easyList[index].calories,
                                              easyList[index].serving,
                                              easyList[index]
                                                  .ingredients
                                                  .toString(),
                                              easyList[index].instruction,
                                            ))));
                              },
                              child: Container(

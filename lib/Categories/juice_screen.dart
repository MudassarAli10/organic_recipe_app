...
import 'package:recipe_app/List%20of%20Recipes%20Items/juice_list.dart';
import '../constant.dart';
import '../detail_screen.dart';
//import '../favouriteScreen.dart';

class JuiceScreen extends StatelessWidget {
  final List<Recipe> juiceList;
  const JuiceScreen(this.juiceList, {super.key});
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: ((context) => DetailScreen(
                                              juiceList[index].name,
                                              juiceList[index].category,
                                              juiceList[index].image,
                                              juiceList[index].time,
                                              juiceList[index].calories,
                                              juiceList[index].serving,
                                              juiceList[index]
                                                  .ingredients
                                                  .toString(),
                                              juiceList[index].instruction,
                                            ))));
                              },
                              child: Container(
